module Api
  module V1
    class RegistrationsController < Devise::RegistrationsController
      before_action :configure_permitted_parameters, only: [:create, :forget_password, :update_password]
      ...
      def create
        ...
        if resource.active_for_authentication?
          ...
          @user = {id: resource.id, first_name: resource.first_name, last_name: resource.last_name, email: resource.email, auth_token: token}
      ...
      def configure_permitted_parameters
        param_keys = [:first_name, :last_name, :email, :password ]
      ...
      def user_format
        {id: current_user.id, first_name: current_user.first_name, last_name: current_user.last_name, email: current_user.email}
      end
    end
  end
end
